    ...
    return (
        <>
            <div className="input-group m-2">
              <span className="input-group-text bg-primary-subtle border-primary-subtle" id="basic-addon2">Content: </span>
              <textarea className="form-control" aria-label="With textarea" placeholder="I have been clicked {clicksNumber} times"></textarea>
            </div>
            <div className="input-group m-2">
              <span className="input-group-text bg-primary-subtle border-primary-subtle" id="basic-addon3">Tag: </span>
